        ...
        $details = [
            ...
            "testo" =>
                "<div style='border: solid 1px; padding: 10px;'>
                        ...
                        <a href='" .$url_cancella . "' style='color: #d81e75; text-decoration: none;font-size:14px;'>Cancella Iscrizione</a>
                    </div><div style='border: solid 1px; padding: 10px;'>
                        Per confermare fai clic su questo link: 
                        <a href='" .$url_conferma . "' style='color: #4CAF50; text-decoration: none;font-size:14px;font-weight:700;'>Conferma Iscrizione</a>
                    </div>",
        ];
...
<br>
<div class="tiabbiamo">
    {!! "Attivita Titolo ". $titolo . " Ti abbiamo mandato una email per <b>CONFERMA o CANCELLAZIONE iscrizione </b> a:  " . $email !!}
</div>
</x-layout_cai>
