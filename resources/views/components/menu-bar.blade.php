        ...
        <form id="autoSubmitForm" method="post" action="{{ url('/attivita/index') }}" class="mt-3">
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-items-center">
                    <label for="attivita" class="me-2" style="width: max-content;color:#ffffff">Seleziona
                        Attività:</label>
                    ...
                    <label for="date" class="me-2" style="width: max-content;color:#fff">Seleziona Da
                        Data:</label>
                    <select name="date" id="date" class="form-select" style="max-width: 150px;">
            ...
            <div class="mt-3">
                <button type="submit" class="btn btn-link invia">Visualizza</button>
            </div>
        </form>
