...
class Eventi extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('tipo_attivitas')->insert(['id' => 10, 'tipo_attivita' => 10,  'order' => 10,'nome' => 'Tutti','descrizione' => 'Tutte le attività']);
...
Soci under 25: iscrizione gratuita', 'catid' => 0, 'state' => 1, 'published' => 1]);
        ...
        DB::table('contents')->insert(['id' => 0, 'titolo' => 'ciao_leggi', 'alias' => 'ciao-leggi', 'introtext' => 'Questa applicazione è stata creata da volontari del CAI Bologna, segnalare a (rino.ruggeri@caibo.it)  errori e suggerimenti<br>Grazie', 'catid' => 0, 'state' => 1, 'published' => 1]);
